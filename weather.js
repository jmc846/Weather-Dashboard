...
// api.openweathermap.org/data/2.5/weather?${searchMethod}=${searchTerm}&APPID=$(appId)&
...
//   $("#temp-2").text("temperature" + response.temperature[0]);
//   $("#wind").text("Wind Speed: " + response.wind.speed[]);
//   $("#humidity").text("Humidity: " + response.main.humidity[0]);
//   $("#uvIndex").text("Uv Index" + response.uv.index[0]);

//   $("div").html(`#city${response.name}weather Deatails`)
